...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EditText txt1 = (EditText) findViewById(R.id.addResult);
        ...
        Button btnReturn = (Button) findViewById(R.id.addReturn);
        btnReturn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent respIntent = new Intent(AddActivity.this, MainActivity.class);
                respIntent.putExtra("AddResult", result);
